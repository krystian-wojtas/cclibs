...
"$cctest" -o $output_format -g pars/volts/global -f SPLINE -d functions/volts/table -m pars/limits -l pars/load -s pars/vs                   > "$outpath/volts-spline.$file_type" &&
...
"$cctest" -o $output_format -g pars/amps/global  -f SPLINE -d functions/amps/table  -m pars/limits -l pars/load -s pars/vs -r pars/amps/reg  > "$outpath/amps-spline.$file_type" &&
...
"$cctest" -o $output_format -g pars/gauss/global -f SPLINE -d functions/gauss/table -m pars/limits -l pars/load -s pars/vs -r pars/gauss/reg > "$outpath/gauss-spline.$file_type" &&

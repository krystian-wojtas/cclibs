...
"$cctest" -o $output_format -g pars/amps/global  -f SQUARE -d functions/amps/test  -m pars/limits -l pars/load -r pars/amps/reg -s pars/vs > "$outpath/amps-test.$file_type" 
) || exit 1

...
= {// "Signal name"      type,         max_n_els, *enum,                         *value,                     num_defaults, flags
    { "RUN_DELAY",       PAR_FLOAT,    1,          NULL,                  { .f = &ccpars_global.run_delay       }, 1, 0                 },
    { "STOP_DELAY",      PAR_FLOAT,    1,          NULL,                  { .f = &ccpars_global.stop_delay      }, 1, 0                 },
    { "ITER_PERIOD_US",  PAR_UNSIGNED, 1,          NULL,                  { .u = &ccpars_global.iter_period_us  }, 1, 0                 },
    { "ABORT_TIME",      PAR_FLOAT,    1,          NULL,                  { .f = &ccpars_global.abort_time      }, 1, 0                 },
    { "FLOT_POINTS_MAX", PAR_UNSIGNED, 1,          NULL,                  { .u = &ccpars_global.flot_points_max }, 1, 0                 },
    { "ACTUATION",       PAR_ENUM,     1,          enum_reg_actuation,    { .u = &ccpars_global.actuation       }, 1, 0                 },
    { "REVERSE_TIME",    PAR_ENUM,     1,          enum_enabled_disabled, { .u = &ccpars_global.reverse_time    }, 1, 0                 },
    { "CYCLE_SELECTOR",  PAR_UNSIGNED, MAX_CYCLES, NULL,                  { .u =  ccpars_global.cycle_selector  }, 1, 0                 },
    { "DYN_ECO_TIME",    PAR_FLOAT,    2,          NULL,                  { .f =  ccpars_global.dyn_eco_time    }, 2, PARS_FIXED_LENGTH },
    { "REG_ERR_RATE",    PAR_ENUM,     1,          enum_reg_err_rate,     { .u = &ccpars_global.reg_err_rate    }, 1, 0                 },
    { "FG_LIMITS",       PAR_ENUM,     1,          enum_enabled_disabled, { .u = &ccpars_global.fg_limits       }, 1, 0                 },
    { "SIM_LOAD",        PAR_ENUM,     1,          enum_enabled_disabled, { .u = &ccpars_global.sim_load        }, 1, 0                 },
    { "STOP_ON_ERROR",   PAR_ENUM,     1,          enum_enabled_disabled, { .u = &ccpars_global.stop_on_error   }, 1, 0                 },
    { "CSV_FORMAT",      PAR_ENUM,     1,          enum_csv_format,       { .u = &ccpars_global.csv_format      }, 1, 0                 },
    { "FLOT_OUTPUT",     PAR_ENUM,     1,          enum_enabled_disabled, { .u = &ccpars_global.flot_output     }, 1, 0                 },
    { "DEBUG_OUTPUT",    PAR_ENUM,     1,          enum_enabled_disabled, { .u = &ccpars_global.debug_output    }, 1, 0                 },
    { "GROUP",           PAR_STRING,   1,          NULL,                  { .s = &ccpars_global.group           }, 1, 0                 },
    { "PROJECT",         PAR_STRING,   1,          NULL,                  { .s = &ccpars_global.project         }, 1, 0                 },
    { "FILE",            PAR_STRING,   1,          NULL,                  { .s = &ccpars_global.file            }, 1, 0                 },
    { NULL }
}
#endif
;
